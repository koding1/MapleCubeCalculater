    ...
    return (
      <div className={classname}>
        ...
        <div id={"option2"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            <option value={100}>{"상관 없음"}</option>
            <option value = {11.157499999999999}>{"STR : +??%"}</option>
            <option value = {11.157499999999999}>{"DEX : +??%"}</option>
            <option value = {11.157499999999999}>{"INT : +??%"}</option>
            <option value = {11.157499999999999}>{"LUK : +??%"}</option>
            <option value = {13.2029}>{"최대 HP : +??%"}</option>
            <option value = {13.2029}>{"최대 MP : +??%"}</option>
            <option value = {9.112}>{"방어력 : +??%"}</option>
            <option value = {8.8795}>{"올스탯 : +??%"}</option>
        ...
        <div id={"option3"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            <option value={100}>{"상관 없음"}</option>
            <option value = {11.343}>{"STR : +??%"}</option>
            <option value = {11.343}>{"DEX : +??%"}</option>
            <option value = {11.343}>{"INT : +??%"}</option>
            <option value = {11.343}>{"LUK : +??%"}</option>
            <option value = {13.593}>{"최대 HP : +??%"}</option>
            <option value = {13.593}>{"최대 MP : +??%"}</option>
            <option value = {9.093}>{"방어력 : +??%"}</option>
            <option value = {9.0698}>{"올스탯 : +??%"}</option>
            <option value={11.25}>{"STR : +9%"}</option>
            <option value={11.25}>{"DEX : +9%"}</option>
            <option value={11.25}>{"INT : +9%"}</option>
            <option value={11.25}>{"LUK : +9%"}</option>
            <option value={13.5}>{"최대 HP : +9%"}</option>
            <option value={13.5}>{"최대 MP : +9%"}</option>
            <option value={9.0}>{"방어력 : +9%"}</option>
            <option value={9.0}>{"올스탯 : +6%"}</option>
            <option value={9.0}>
              {"HP 회복 아이템 및 회복 스킬 효율 : +30%"}
            </option>
            <option value={0.093}>{"STR : +12%"}</option>
            <option value={0.093}>{"DEX : +12%"}</option>
            <option value={0.093}>{"INT : +12%"}</option>
            <option value={0.093}>{"LUK : +12%"}</option>
            <option value={0.093}>{"최대 HP : +12%"}</option>
            <option value={0.093}>{"최대 MP : +12%"}</option>
            <option value={0.093}>{"방어력 : +12%"}</option>
