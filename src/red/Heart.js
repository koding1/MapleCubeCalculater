...
function Heart({grade, setOption, optionPer}) {
...
<option value = {12.9032}>{"STR : +12%"}</option>
<option value = {12.9032}>{"DEX : +12%"}</option>
<option value = {12.9032}>{"INT : +12%"}</option>
<option value = {12.9032}>{"LUK : +12%"}</option>
<option value = {12.9032}>{"최대 HP : +12%"}</option>
<option value = {12.9032}>{"최대 MP : +12%"}</option>
<option value = {12.9032}>{"방어력 : +12%"}</option>
<option value = {9.6774}>{"올스탯 : +9%"}</option>
                    </select>
                </div>
                ...
                <div id = {"option2"}>
                    ...
                    <select className = {cubeStyles.optionSelect} onChange={onChange}>
                    <option value = {100}>{"상관 없음"}</option>
<option value = {11.5176}>{"STR : +??%"}</option>
<option value = {11.5176}>{"DEX : +??%"}</option>
<option value = {11.5176}>{"INT : +??%"}</option>
<option value = {11.5176}>{"LUK : +??%"}</option>
<option value = {13.563}>{"최대 HP : +??%"}</option>
<option value = {13.563}>{"최대 MP : +??%"}</option>
<option value = {9.472100000000001}>{"방어력 : +??%"}</option>
<option value = {9.149500000000002}>{"올스탯 : +??%"}</option>
...
<option value = {1.2903}>{"STR : +12%"}</option>
<option value = {1.2903}>{"DEX : +12%"}</option>
<option value = {1.2903}>{"INT : +12%"}</option>
<option value = {1.2903}>{"LUK : +12%"}</option>
<option value = {1.2903}>{"최대 HP : +12%"}</option>
<option value = {1.2903}>{"최대 MP : +12%"}</option>
<option value = {1.2903}>{"방어력 : +12%"}</option>
<option value = {0.9677}>{"올스탯 : +9%"}</option>
                    </select>
                </div>
                ...
                <div id = {"option3"}>
                    ...
                    <select className = {cubeStyles.optionSelect} onChange={onChange}>
                    <option value = {100}>{"상관 없음"}</option>
<option value = {11.379}>{"STR : +??%"}</option>
<option value = {11.379}>{"DEX : +??%"}</option>
<option value = {11.379}>{"INT : +??%"}</option>
<option value = {11.379}>{"LUK : +??%"}</option>
<option value = {13.629}>{"최대 HP : +??%"}</option>
<option value = {13.629}>{"최대 MP : +??%"}</option>
<option value = {9.129}>{"방어력 : +??%"}</option>
<option value = {9.0968}>{"올스탯 : +??%"}</option>
...
<option value = {0.1290}>{"STR : +12%"}</option>
<option value = {0.1290}>{"DEX : +12%"}</option>
<option value = {0.1290}>{"INT : +12%"}</option>
<option value = {0.1290}>{"LUK : +12%"}</option>
<option value = {0.1290}>{"최대 HP : +12%"}</option>
<option value = {0.1290}>{"최대 MP : +12%"}</option>
<option value = {0.1290}>{"방어력 : +12%"}</option>
<option value = {0.0968}>{"올스탯 : +9%"}</option>
                    </select>
                </div>
            </div>
        )
