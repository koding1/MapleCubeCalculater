...
function Shoulder({grade, setOption, optionPer}) {
    const classname = "shoulder"
...
<option value = {6.9231}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {6.9231}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {6.9231}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
...
<option value = {7.6154}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {7.6154}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {7.6154}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
...
<option value = {7.6923}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {7.6923}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {7.6923}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
                    </select>
                </div>
...
<option value = {0.7692}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {0.7692}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {0.7692}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
                    </select>
                </div>
...
<option value = {0.0769}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {0.0769}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {0.0769}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
                    </select>
                </div>
            </div>
        )
