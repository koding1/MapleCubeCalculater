...
<option value = {6.6667}>피격 시 10% 확률로 데미지의 20% 무시</option>
<option value = {6.6667}>피격 시 10% 확률로 데미지의 40% 무시</option>
<option value = {6.6667}>모든 스킬의 재사용 대기시간 : -1초(10초 이하는 5%감소 5초 미만으로 감소 불가)</option>
<option value = {4.4444}>모든 스킬의 재사용 대기시간 : -2초(10초 이하는 10%감소 5초 미만으로 감소 불가)</option>
<option value = {6.6667}>쓸만한 어드밴스드 블레스 스킬 사용 가능</option>
                    </select>
                </div>
                ...
                <div id = {"option2"}>
                    ...
                    <select className = {cubeStyles.optionSelect} onChange={onChange}>
                    <option value = {100}>상관 없음</option>
<option value = {8.9246}>STR : +??%</option>
<option value = {8.9246}>DEX : +??%</option>
<option value = {8.9246}>INT : +??%</option>
<option value = {8.9246}>LUK : +??%</option>
<option value = {10.531799999999999}>최대 HP : +??%</option>
<option value = {10.531799999999999}>최대 MP : +??%</option>
<option value = {7.317500000000001}>방어력 : +??%</option>
<option value = {7.0953}>올스탯 : +??%</option>
...
<option value = {6.4286}>쓸만한 미스틱 도어 스킬 사용 가능</option>
<option value = {0.8889}>STR : +12%</option>
<option value = {0.8889}>DEX : +12%</option>
<option value = {0.8889}>INT : +12%</option>
<option value = {0.8889}>LUK : +12%</option>
<option value = {0.8889}>최대 HP : +12%</option>
<option value = {0.8889}>최대 MP : +12%</option>
<option value = {0.8889}>방어력 : +12%</option>
<option value = {0.6667}>올스탯 : +9%</option>
<option value = {0.6667}>피격 시 10% 확률로 데미지의 20% 무시</option>
<option value = {0.6667}>피격 시 10% 확률로 데미지의 40% 무시</option>
<option value = {0.6667}>모든 스킬의 재사용 대기시간 : -1초(10초 이하는 5%감소 5초 미만으로 감소 불가)</option>
<option value = {0.4444}>모든 스킬의 재사용 대기시간 : -2초(10초 이하는 10%감소 5초 미만으로 감소 불가)</option>
<option value = {0.6667}>쓸만한 어드밴스드 블레스 스킬 사용 가능</option>
                    </select>
                </div>
                ...
                <div id = {"option3"}>
                    ...
                    <select className = {cubeStyles.optionSelect} onChange={onChange}>
                    <option value = {100}>상관 없음</option>
<option value = {8.9282}>STR : +??%</option>
<option value = {8.9282}>DEX : +??%</option>
<option value = {8.9282}>INT : +??%</option>
<option value = {8.9282}>LUK : +??%</option>
<option value = {10.696000000000002}>최대 HP : +??%</option>
<option value = {10.696000000000002}>최대 MP : +??%</option>
<option value = {7.160299999999999}>방어력 : +??%</option>
<option value = {7.1381}>올스탯 : +??%</option>
...
<option value = {7.0714}>쓸만한 미스틱 도어 스킬 사용 가능</option>
<option value = {0.0889}>STR : +12%</option>
<option value = {0.0889}>DEX : +12%</option>
<option value = {0.0889}>INT : +12%</option>
<option value = {0.0889}>LUK : +12%</option>
<option value = {0.0889}>최대 HP : +12%</option>
<option value = {0.0889}>최대 MP : +12%</option>
<option value = {0.0889}>방어력 : +12%</option>
<option value = {0.0667}>올스탯 : +9%</option>
<option value = {0.0667}>피격 시 10% 확률로 데미지의 20% 무시</option>
<option value = {0.0667}>피격 시 10% 확률로 데미지의 40% 무시</option>
<option value = {0.0667}>모든 스킬의 재사용 대기시간 : -1초(10초 이하는 5%감소 5초 미만으로 감소 불가)</option>
<option value = {0.0444}>모든 스킬의 재사용 대기시간 : -2초(10초 이하는 10%감소 5초 미만으로 감소 불가)</option>
<option value = {0.0667}>쓸만한 어드밴스드 블레스 스킬 사용 가능</option>
                    </select>
                </div>
            </div>
        )
