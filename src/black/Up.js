...
<option value = {4.8485}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {4.8485}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {4.8485}>{"피격 후 무적시간 : +2초"}</option>
<option value = {4.8485}>{"피격 시 2% 확률로 7초간 무적"}</option>
<option value = {4.8485}>{"20% 확률로 받은 피해의 50%를 반사"}</option>
<option value = {2.4242}>{"20% 확률로 받은 피해의 70%를 반사"}</option>
<option value = {4.8485}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
...
<option value = {1.3953}>{"피격 시 10% 확률로 데미지의 20% 무시"}</option>
<option value = {1.3953}>{"피격 시 10% 확률로 데미지의 40% 무시"}</option>
...
<option value = {7.1970}>{"STR : +9%"}</option>
<option value = {7.1970}>{"DEX : +9%"}</option>
<option value = {7.1970}>{"INT : +9%"}</option>
<option value = {7.1970}>{"LUK : +9%"}</option>
...
<option value = {5.7576}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {5.7576}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {5.7576}>{"피격 후 무적시간 : +2초"}</option>
<option value = {5.7576}>{"피격 시 2% 확률로 7초간 무적"}</option>
<option value = {5.7576}>{"20% 확률로 받은 피해의 50%를 반사"}</option>
<option value = {2.8788}>{"20% 확률로 받은 피해의 70%를 반사"}</option>
<option value = {5.7576}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
...
<option value = {0.3488}>{"피격 시 10% 확률로 데미지의 20% 무시"}</option>
<option value = {0.3488}>{"피격 시 10% 확률로 데미지의 40% 무시"}</option>
...
<option value = {6.0606}>{"20% 확률로 받은 피해의 50%를 반사"}</option>
<option value = {3.0303}>{"20% 확률로 받은 피해의 70%를 반사"}</option>
...
<option value = {1.2121}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {1.2121}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {1.2121}>{"피격 후 무적시간 : +2초"}</option>
<option value = {1.2121}>{"피격 시 2% 확률로 7초간 무적"}</option>
<option value = {1.2121}>{"20% 확률로 받은 피해의 50%를 반사"}</option>
<option value = {0.6061}>{"20% 확률로 받은 피해의 70%를 반사"}</option>
<option value = {1.2121}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
                    </select>
                </div>
...
<option value = {12.5000}>{"STR : +6%"}</option>
<option value = {12.5000}>{"DEX : +6%"}</option>
<option value = {12.5000}>{"INT : +6%"}</option>
<option value = {12.5000}>{"LUK : +6%"}</option>
<option value = {12.5000}>{"최대 HP : +6%"}</option>
<option value = {12.5000}>{"최대 MP : +6%"}</option>
<option value = {7.5000}>{"방어력 : +6%"}</option>
<option value = {5.0000}>{"올스탯 : +3%"}</option>
<option value = {7.5000}>{"피격 후 무적시간 : +1초"}</option>
...
<option value = {0.3030}>{"방어력 : +9%"}</option>
<option value = {0.3030}>{"올스탯 : +6%"}</option>
<option value = {0.3030}>{"피격 시 5% 확률로 데미지의 20% 무시"}</option>
<option value = {0.3030}>{"피격 시 5% 확률로 데미지의 40% 무시"}</option>
<option value = {0.3030}>{"피격 후 무적시간 : +2초"}</option>
<option value = {0.3030}>{"피격 시 2% 확률로 7초간 무적"}</option>
<option value = {0.3030}>{"20% 확률로 받은 피해의 50%를 반사"}</option>
<option value = {0.1515}>{"20% 확률로 받은 피해의 70%를 반사"}</option>
<option value = {0.3030}>{"HP 회복 아이템 및 회복 스킬 효율 : +30%"}</option>
                    </select>
                </div>
            </div>
        )
