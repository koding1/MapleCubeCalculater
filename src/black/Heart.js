    ...
    return (
      <div className={classname}>
        ...
        <div id={"option5"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            <option value={100}>{"상관 없음"}</option>
            <option value={11.6715}>{"STR : +??%"}</option>
            <option value={11.6715}>{"DEX : +??%"}</option>
            <option value={11.6715}>{"INT : +??%"}</option>
            <option value={11.6715}>{"LUK : +??%"}</option>
            <option value={13.489700000000001}>{"최대 HP : +??%"}</option>
            <option value={13.489700000000001}>{"최대 MP : +??%"}</option>
            <option value={9.8533}>{"방어력 : +??%"}</option>
            <option value={9.2082}>{"올스탯 : +??%"}</option>
            ...
            <option value={2.5806}>{"STR : +12%"}</option>
            <option value={2.5806}>{"DEX : +12%"}</option>
            <option value={2.5806}>{"INT : +12%"}</option>
            <option value={2.5806}>{"LUK : +12%"}</option>
            <option value={2.5806}>{"최대 HP : +12%"}</option>
            <option value={2.5806}>{"최대 MP : +12%"}</option>
            <option value={2.5806}>{"방어력 : +12%"}</option>
            <option value={1.9355}>{"올스탯 : +9%"}</option>
          </select>
        </div>
        ...
        <div id={"option6"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            ...
            <option value={13.599699999999999}>{"최대 HP : +??%"}</option>
            <option value={13.599699999999999}>{"최대 MP : +??%"}</option>
            <option value={9.281600000000001}>{"방어력 : +??%"}</option>
            <option value={9.1203}>{"올스탯 : +??%"}</option>
            ...
            <option value={0.6452}>{"STR : +12%"}</option>
            <option value={0.6452}>{"DEX : +12%"}</option>
            <option value={0.6452}>{"INT : +12%"}</option>
            <option value={0.6452}>{"LUK : +12%"}</option>
            <option value={0.6452}>{"최대 HP : +12%"}</option>
            <option value={0.6452}>{"최대 MP : +12%"}</option>
            <option value={0.6452}>{"방어력 : +12%"}</option>
            <option value={0.4839}>{"올스탯 : +9%"}</option>
          </select>
        </div>
      </div>
    );
