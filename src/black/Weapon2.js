    ...
    return (
      <div className={classname}>
        ...
        <div id={"option5"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            <option value={100}>{"상관 없음"}</option>
            <option value={10.656500000000001}>{"STR : +??%"}</option>
            <option value={10.656500000000001}>{"DEX : +??%"}</option>
            <option value={10.656500000000001}>{"INT : +??%"}</option>
            <option value={10.656500000000001}>{"LUK : +??%"}</option>
            <option value={4.6548}>{"공격력 : +??%"}</option>
            <option value={4.6548}>{"마력 : +??%"}</option>
            <option value={5.0469}>{"크리티컬 확률 : +??%"}</option>
            <option value={4.6548}>{"데미지 : +??%"}</option>
            <option value={5.0469}>{"올스탯 : +??%"}</option>
            <option value={4.6548}>{"몬스터 방어율 무시 : +??%"}</option>
        ...
        <div id={"option6"}>
          ...
          <select className = {cubeStyles.optionSelect} onChange={onChange}>
            <option value={100}>{"상관 없음"}</option>
            <option value={10.8163}>{"STR : +??%"}</option>
            <option value={10.8163}>{"DEX : +??%"}</option>
            <option value={10.8163}>{"INT : +??%"}</option>
            <option value={10.8163}>{"LUK : +??%"}</option>
            <option value={4.4245}>{"공격력 : +??%"}</option>
            <option value={4.4245}>{"마력 : +??%"}</option>
            <option value={4.5226}>{"크리티컬 확률 : +??%"}</option>
            <option value={4.4245}>{"데미지 : +??%"}</option>
            <option value={4.5226}>{"올스탯 : +??%"}</option>
            <option value={4.4245}>{"몬스터 방어율 무시 : +??%"}</option>
